<div class="row">
    ...
    <div class="col-md-6">
        <form id="form_1" method="post" action="<?= url('admin/password') ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="password2" value="" class="form-control" placeholder="Password" id="password2">
            </div>
...
<script>
    $(document).ready(function() {
        $('#form_1').submit(function(e) {
            ...
            $.ajax({
                url: '<?=url('admin/password/submit')?>', // Url to which the request is send
